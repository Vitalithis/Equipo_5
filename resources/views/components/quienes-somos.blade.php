<section id="quienes-somos">
    <div class="flex flex-col md:flex-row w-full overflow-hidden h-fit">
        ...
        <div class="text-center md:w-1/2 flex items-center justify-center h-full bg-white py-8 md:py-20">
            <div class="bg-blueLight px-4 py-16 my-20 w-full flex flex-col items-center">
                ...
                <p class="text-blueDark text-2xl mt-4">
                    Plantas Editha es una empresa apasionada por la naturaleza que ofrece plantas decorativas, nativas y
                    exóticas, insumos y asesoría personalizada, brindando un servicio completo a personas y empresas que
                    aman lo natural.
                </p>
                <div class="flex gap-4 mt-6">
                    <button
                        class="border border-blueDark text-blueDark px-4 py-2 rounded-md hover:bg-blueLight transition">
        ...
        <div class="md:w-1/2 flex items-center justify-center md:my-0 pr-4">
            <img src={{ asset('/storage/images/quienes.jpg') }} alt="Manos unidas sobre un tronco"
