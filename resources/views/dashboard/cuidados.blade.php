        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($cuidados as $cuidado)
                    <tr>
                        <td class="px-4 py-3">{{ $cuidado->producto->nombre ?? '-' }}</td>
                        <td class="px-4 py-3">{{ $cuidado->frecuencia_riego }}</td>
                        <td class="px-4 py-3">{{ $cuidado->cantidad_agua }}</td>
                        <td class="px-4 py-3">{{ $cuidado->tipo_luz }}</td>
                        <td class="px-4 py-3">{{ $cuidado->frecuencia_abono ?? '-' }}</td>
