            ...
            <table class="min-w-full divide-y divide-eaccent2 text-sm text-left">
                ...
                @forelse($insumos as $insumo)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap capitalize">{{ $insumo->tipo_uso }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $insumo->stock }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($insumo->tipo_uso === 'venta')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="{{ route('insumos.edit', ['id' => $insumo->id]) }}"
