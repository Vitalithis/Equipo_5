        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="frecuencia_riego" id="frecuencia_riego" value="{{ old('frecuencia_riego', $cuidado->frecuencia_riego ?? '') }}"
                ...
                <div>
                    ...
                    <input type="text" name="cantidad_agua" id="cantidad_agua" value="{{ old('cantidad_agua', $cuidado->cantidad_agua ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="tipo_luz" id="tipo_luz" value="{{ old('tipo_luz', $cuidado->tipo_luz ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="temperatura_ideal" id="temperatura_ideal" value="{{ old('temperatura_ideal', $cuidado->temperatura_ideal ?? '') }}"
                ...
                <div>
                    ...
                    <input type="text" name="tipo_sustrato" id="tipo_sustrato" value="{{ old('tipo_sustrato', $cuidado->tipo_sustrato ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="frecuencia_abono" id="frecuencia_abono" value="{{ old('frecuencia_abono', $cuidado->frecuencia_abono ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="plagas_comunes" id="plagas_comunes" value="{{ old('plagas_comunes', $cuidado->plagas_comunes ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
