...
<div class="w-full md:w-3/4 lg:w-4/5 mx-auto bg-white rounded-lg shadow-md p-6">
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1 space-y-4 text-blueDark">
            ...
            <!-- Agregar al carrito -->
            <form method="POST" action="<?php echo e(route('cart.agregar')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev\Personal\Equipo_5\resources\views/products/show.blade.php ENDPATH**/ ?>