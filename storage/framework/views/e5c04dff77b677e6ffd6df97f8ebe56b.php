<div class="w-full h-screen px-10">
  <div
    class="relative w-full bg-white rounded-4xl h-4/5 overflow-hidden "
  >
	<slide
		name="slide"
		duration={500}
    ...
    <!-- Imagen como fondo que cubre todo -->
    <img
    ...
    <div
      class="absolute bottom-0 left-1/2 -translate-x-1/2 w-42 h-10 bg-white rounded-t-xl w-1/6 "
    >
	  <div class="absolute inset-0 flex items-center justify-center">
		<img
		  src='/storage/images/arrowdown.svg'
