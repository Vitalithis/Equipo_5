...
<head>
    <meta charset="UTF-8">
    <title>Ficha de Cuidado - <?php echo e($cuidado->producto->nombre); ?></title>
    <style>
        body {
    ...
    <section>
        ...
        <table>
            <tr>
                ...
                <td><?php echo e($cuidado->frecuencia_riego); ?></td>
            </tr>
            <tr>
                <td class="label">Cantidad de agua</td>
                <td><?php echo e($cuidado->cantidad_agua); ?></td>
            </tr>
            <tr>
                <td class="label">Tipo de luz</td>
                <td><?php echo e($cuidado->tipo_luz); ?></td>
            </tr>
            <tr>
                <td class="label">Temperatura ideal</td>
                <td><?php echo e($cuidado->temperatura_ideal ?? 'No especificada'); ?></td>
            </tr>
            <tr>
                <td class="label">Tipo de sustrato</td>
                <td><?php echo e($cuidado->tipo_sustrato ?? 'No especificado'); ?></td>
            </tr>
            <tr>
                <td class="label">Frecuencia de abono</td>
                <td><?php echo e($cuidado->frecuencia_abono ?? 'No especificada'); ?></td>
            </tr>
            <tr>
                <td class="label">Plagas comunes</td>
                <td><?php echo e($cuidado->plagas_comunes ?? 'No especificadas'); ?></td>
            </tr>
        </table>
    </section>

    <?php if($cuidado->cuidados_adicionales): ?>
    <section>
        <h2>Cuidados Adicionales</h2>
        <p><?php echo nl2br(e($cuidado->cuidados_adicionales)); ?></p>
    </section>
    <?php endif; ?>
