                ...
                <tbody class="divide-y divide-eaccent2 font-['Roboto'] text-gray-800">
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <?php echo e($user->roles->pluck('name')->join(', ') ?: 'Sin rol'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xampp\Equipo_5\Equipo_5\resources\views/dashboard/users/index.blade.php ENDPATH**/ ?>