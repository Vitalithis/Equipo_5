...
<div class="py-8 px-4 md:px-8 w-full font-['Roboto'] text-gray-800">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <form method="GET" action="<?php echo e(route('dashboard.finanzas')); ?>" class="flex flex-wrap items-center gap-4">
                ...
                <?php if(request()->filled('desde') || request()->filled('hasta')): ?>
                    <a href="<?php echo e(route('dashboard.finanzas')); ?>"
