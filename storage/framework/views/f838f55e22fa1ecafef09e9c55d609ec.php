            ...
            <table class="min-w-full divide-y divide-eaccent2 text-sm text-left">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $insumos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insumo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap capitalize"><?php echo e($insumo->tipo_uso); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e($insumo->stock); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php if($insumo->tipo_uso === 'venta'): ?>
                                $<?php echo e(number_format($insumo->precio, 0, ',', '.')); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?php echo e(route('insumos.edit', ['id' => $insumo->id])); ?>"
